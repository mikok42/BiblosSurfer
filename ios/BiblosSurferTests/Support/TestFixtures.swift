...
enum TestFixtures {
    static let sampleBookTitle = "The Sample Voyage"
    static let sampleBookAuthor = "Ferdek Test"

    /// The EPUB bundled with the app target, generated by `scripts/make-sample-epub.py`.
    ...
    static func temporarySampleBookURL() throws -> URL {
        ...
        let destination = directory.appendingPathComponent("SampleBook.epub")
